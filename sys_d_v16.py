...
def print_status(message, status="INFO"):
    ...
    color = status_colors.get(status, Colors.HACKER_GREEN)
    prefix = {
        "INFO": "[*]",
        "SUCCESS": "[+]",
        "WARNING": "[!]",
...
{Colors.RESET}
{Colors.NEON_GREEN}
                    SYSTEM SCANNER v4.0 - HACKER MODE
...
if __name__ == "__main__":
    ...
    try:
        ...
        print()
        print_colored("▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄", Colors.MATRIX_GREEN)
        print_colored("█                                                       █", Colors.MATRIX_GREEN)
        print_colored("█              PENETRATION SCAN COMPLETE               █", Colors.MATRIX_GREEN)
        print_colored("█                                                       █", Colors.MATRIX_GREEN)
        print_colored("▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀", Colors.MATRIX_GREEN)
        print("\n\n\n")
