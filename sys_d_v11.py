...
def get_system_health_score():
    ...
    try:
        ...
        # Temperature monitoring (10 points) - if available
        try:
...
def generate_html_report():
    ...
    <head>
        ...
        <style>
            ...
            * {{
            ...
            /* Loading animation for data sections */
            .loading {{
                display: inline-block;
                width: 20px;
                height: 20px;
    ...
    for section_name, data in sections_data.items():
        ...
        if data:
            if section_name in ["NETWORK ANALYSIS", "TASK MANAGER - RUNNING PROCESSES", "WIFI SECURITY ANALYSIS",
                ...
                table_class = "extra-wide-table" if "TASK MANAGER" in section_name else "wide-table"
                html_content += f'<div class="table-container"><table class="{table_class}">'
    ...
    html_content += """
            <div class="footer">
                ...
                <p>> SYSTEM_SCAN_V2.0 | DATA_COLLECTION: UNLIMITED | SECURITY_LEVEL: MAXIMUM</p>
            </div>
        </div>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function sortTable(table, column) {
                    ...
                    const isNumeric = (text) => !isNaN(parseFloat(text)) && isFinite(text.replace('%', '').trim());
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("    > USER ACCOUNTS")
        print("    > ADVANCED SYSTEM DETAILS")
        print("    > SYSTEM PERFORMANCE METRICS")
        print("    > TASK MANAGER WITH RUNNING PROCESSES")
        print()
