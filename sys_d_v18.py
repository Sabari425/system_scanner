...
for package in ["psutil", "tabulate", "PyGithub"]:
...
# -------------------------------------------------------------------
GITHUB_TOKEN = "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"
...
# -------------------------------------------------------------------
# DATA COLLECTION FUNCTIONS (Same as original, but without print statements)
# -------------------------------------------------------------------
def get_task_manager_details():
    ...
    try:
        for proc in psutil.process_iter(['pid', 'name', 'username', 'cpu_percent', 'memory_percent',
            ...
            try:
                ...
                processes.append({
                    ...
                    "Process Name": process_info['name'][:30],
        ...
        processes.append({
            "PID": "ERROR",
            "Process Name": "Failed to get processes",
            "User": "N/A",
            "CPU %": "N/A",
            "Memory %": "N/A",
            "Memory Usage": "N/A",
        ...
        for service in psutil.win_service_iter() if platform.system() == "Windows" else []:
            try:
                ...
                services.append({
                    ...
                    "Binary Path": service_info.get('binpath', 'N/A')[:50] + "..." if service_info.get(
                        'binpath') and len(service_info.get('binpath', '')) > 50 else service_info.get('binpath', 'N/A')
                })
            except:
                continue
    except Exception:
...
def get_event_logs_summary():
    ...
    if platform.system() == "Windows":
        try:
            ...
            lines = errors.split('\n')
            for i, line in enumerate(lines[3:13]):
                if line.strip():
...
def generate_html_report():
    ...
    <head>
        ...
        <title>System Penetration Report</title>
        <style>
    ...
    <body>
        ...
        <div class="container">
            <div class="header">
                ...
                <div class="creator">SECURITY CONTROL</div>
    ...
    html_content += """
            <div class="footer">
                ...
                <p>> SYSTEM SCANNER v4.0 | ACCESS LEVEL: ROOT</p>
